...
public class Socket2 extends DatagramSocket{
	...
	//Contrutores reais
	public Socket2(InetAddress address, int port) throws IOException{
		super();
	...
	public Socket2(String host, int port) throws IOException{
		super();
		this.is_server = false;
		boolean done = false;
		do{
	...
	//Cliente
	public Socket2(int server_port, InetAddress server) throws IOException{
		super();
